...
public class SubscribeZkClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            initConfig.setDbUrl("jdbc:mysql://192.168.56.103:3306/mydb");
            initConfig.setDbUser("root");
            // 实例化一个Manage Server
            ZkClient clientManage = new ZkClient(ZOOKEEPER_SERVER, 5000, 50000, new BytesPushThroughSerializer());
            ...
            for (int i = 0; i < CLIENT_QTY; ++i) {
                ZkClient client = new ZkClient(ZOOKEEPER_SERVER, 5000, 50000, new BytesPushThroughSerializer());
                clients.add(client);
